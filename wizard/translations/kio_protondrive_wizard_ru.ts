...
<context>
    ...
    <message>
        ...
        <translation>Proton Drive требует однократного входа. Откроется браузер — после этого служба синхронизации будет использовать ту же сессию.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Уже выполнен вход в Proton Drive.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Вход не был завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Хранение учётных данных</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>По умолчанию фоновая служба синхронизации хранит сессию Proton Drive в обычном файле (доступном для чтения только вам, но не зашифрованном). Вместо этого можно переключиться на хранилище, зашифрованное GPG («pass»), — или просто пропустить этот шаг и изменить позже.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Оставить по умолчанию (unsafe_file)</translation>
    </message>
    <message>
        <location filename="../qml/Credentials.qml" line="89"/>
        <source>Use pass (GPG-encrypted)</source>
        <translation>Использовать pass (шифрование GPG)</translation>
    </message>
    <message>
        ...
        <translation>Предварительно должны быть установлены «pass» и «gpg»: sudo apt install pass gpg</translation>
    </message>
    <message>
        ...
        <translation>Подходящий ключ GPG не найден — введите адрес эл. почты, чтобы создать его (пароль будет запрошен отдельно):</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось настроить pass.</translation>
    </message>
    <message>
        <location filename="../qml/Credentials.qml" line="140"/>
        <source>Generating a key and initializing pass…</source>
        <translation>Создание ключа и инициализация pass…</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Избранное Dolphin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Добавить на панель «Точки входа» Dolphin</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Настройка завершена. Служба синхронизации вскоре применит ваши настройки — перезапустите её самостоятельно, если не хотите ждать: systemctl --user restart kio-protondrive-sync-daemon</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Настроить Proton Drive</translation>
    </message>
    <message>
        ...
        <translation>Это выполнит вход в Proton Drive и позволит выбрать, как фоновая служба синхронизации хранит вашу сессию. После настройки вы сможете закреплять любой файл или папку в Dolphin, чтобы они оставались доступны локально.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Настройка Proton Drive</translation>
    </message>
</context>
</TS>
